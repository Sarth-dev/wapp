        ...
        <div id="p2chat" className="w-full text-white h-screen bg-slate-600">
          <div id="p2c1" className="w-full flex h-[10vh]  bg-[#222E35]">
            ...
            <div id="p2c11" className="w-[70%] h-full bg-[#222E35]">
              <h2 className="mt-2 text-md ml-1">Narendra Modi</h2>
              <p className="text-sm ml-1">last seen today at 04:34PM ..</p>
            </div>
          ...
          <div id="p2c2" className="w-full h-[80vh] bg-[#222E35]">
            <ModalDialog className="w-full  h-full" isOpen={show}>
              ...
              <p className="text-md text-center font-medium ">
                Narendra Damodardas Modi (Gujarati: [ˈnəɾendɾə dɑmodəɾˈdɑs
                ˈmodiː] ; born 17 September 1950) is an Indian politician who
                has served as the 14th prime minister of India since May 2014.
                Modi was the chief minister of Gujarat from 2001 to 2014 and is
