        ...
        <div id="p2chat" className="w-full text-white h-screen bg-slate-600">
          <div id="p2c1" className="w-full flex h-[10vh]  bg-[#222E35]">
            ...
            <div id="p2c11" className="w-[70%] h-full bg-[#222E35]">
              <h2 className="mt-2 text-md ml-1">Navneet Rana</h2>
              <p className="text-sm ml-1">last seen today at 01:19PM ..</p>
            </div>
          ...
          <div id="p2c2" className="w-full h-[80vh] bg-[#222E35]">
            <ModalDialog className="w-full  h-full" isOpen={show}>
              ...
              <p className="text-md text-center font-medium ">
                Navneet Kaur Rana (also known as Navneet Ravi Rana) is an Indian
                politician and a former Indian actress who mainly acted in
                Telugu cinema. She was an elected Member of Parliament (MP) from
                Amravati in 2019 Lok Sabha elections as an independent candidate
              </p>
              <br />
              <button
                onClick={() => {
        ...
        <div id="p2chat1" className="w-full h-screen bg-slate-600">
          ...
          <div id="p2c2" className="w-full h-[80vh] bg-[#222E35]">
            ...
            >
              ...
              <p className="text-md text-center font-medium ">
                I Navneet Kaur Rana (also known as Navneet Ravi Rana) is an
                Indian politician and a former Indian actress who mainly acted
                in Telugu cinema. She is an elected Member of Parliament (MP)
                from Amravati in 2019 Lok Sha elections as an independent
                candidate.
              </p>
              <br />
              <button
