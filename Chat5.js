        ...
        <div id="p2chat" className="w-full text-white h-screen bg-slate-600">
          <div id="p2c1" className="w-full flex h-[10vh]  bg-[#222E35]">
            ...
            <div id="p2c11" className="w-[70%] h-full bg-[#222E35]">
              <h2 className="mt-2 text-md ml-1">Joe biden</h2>
              <p className="text-sm ml-1">last seen today at 05:43PM ..</p>
            </div>
          ...
          <div id="p2c2" className="w-full h-[80vh] bg-[#222E35]">
            <ModalDialog className="w-full  h-full" isOpen={show}>
              ...
              <p className="text-md text-center font-medium ">
                Joseph Robinette Biden Jr. (/ˈbaɪdən/ BY-dən; born November 20,
                1942) is an American politician who is the 46th and current
                president of the United States since 2021. A member of the
                Democratic Party, he previously served as the 47th vice
