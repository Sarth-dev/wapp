        ...
        <div id="p2chat" className="w-full text-white h-screen bg-slate-600">
          <div id="p2c1" className="w-full flex h-[10vh]  bg-[#222E35]">
            ...
            <div id="p2c11" className="w-[70%] h-full bg-[#222E35]">
              <h2 className="mt-2 text-md ml-1">Giorgia Meloni</h2>
              <p className="text-sm ml-1">last seen today at 02:04PM ..</p>
            </div>
          ...
          <div id="p2c2" className="w-full h-[80vh] bg-[#222E35]">
            <ModalDialog className="w-full  h-full" isOpen={show}>
              ...
              <p className="text-md text-center font-medium ">
                Giorgia Meloni (Italian: born 15 January 1977) is an Italian
                politician and stateswoman who has been serving as the prime
                minister of Italy since October 2022, the first woman to hold
                this position. A member of the Chamber of Deputies since 2006.
              </p>
              <br />
              <button
                onClick={() => {
      ...
      {isVisible && (
        <div id="p2chat1" className="w-full h-screen bg-slate-600">
          <div id="p2c1" className="w-full flex h-[10vh]  bg-[#222E35]">
            ...
            <div id="p2c11" className="w-[70%] h-full bg-[#222E35]">
              <h2 className="mt-2 text-md ml-1">Giorgia Meloni</h2>
              <p className="text-sm ml-1">last seen today at 11:34PM ..</p>
            </div>
            <div id="p2c12" className="w-[30%] flex h-full ">
              <div className="w-[80%] h-full ">
